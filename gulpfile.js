...
function prodCss() {
  return (
    ...
    .pipe(cleanCSS())
    .pipe(concat('hosting-bundle.min.css'))
...
function prodRtlCss() {
  return (
    ...
    .pipe(cleanCSS())
    .pipe(concat('hosting-bundle-rtl.min.css'))
    .pipe(gulp.dest('dist/assets/css'))
  );
}
...
function prodJs() {
  return (
    gulp.src(['assets/js/vendors/jquery.min.js', 'assets/js/vendors/**/*.js', '!assets/js/vendors/vanta/*.js', 'assets/js/*.js'])
    .pipe(uglify())
    .pipe(concat('hosting-bundle.min.js'))
